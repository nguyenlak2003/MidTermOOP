 ...
 * @author Admin
 */
public class NewMemberInputForm extends javax.swing.JFrame {

    /**
     * Creates new form InputForm
     */
    public NewMemberInputForm() {
        initComponents();
        setVisible(true);
    ...
    private void initComponents() {
        ...
        jLabel9.setText("Thông tin thành viên mới");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NewMemberInputForm().setVisible(true);
            }
        });
    }
