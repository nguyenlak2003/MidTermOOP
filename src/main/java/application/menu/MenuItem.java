...
public class MenuItem extends JPanel {
    ...
    private Icon getIcon() {
        Color lightColor = FlatUIUtils.getUIColor("menu.icon.lightColor", Color.decode("#969696"));
        Color darkColor = FlatUIUtils.getUIColor("menu.icon.darkColor", Color.decode("#969696"));
    ...
    private void init() {
        ...
        for (int i = 0; i < menus.length; i++) {
            ...
            menuItem.setHorizontalAlignment(menuItem.getComponentOrientation().isLeftToRight() ? JButton.LEFT : JButton.RIGHT);
            if (i == 0) {
                menuItem.setIcon(getIcon());
                // Hiển thị các subItem
